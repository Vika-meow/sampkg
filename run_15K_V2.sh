...
#target_dataset='DBP_en_DBP_de_15K_V2'
#python3 main.py \
#    --target_dataset ${target_dataset} \
#    --KG1_rel_triple_path ${data_folder}'processed_data/rel_triples/rel_triples_DBP_en_V2' \
#    --KG1_attr_triple_path ${data_folder}'processed_data/attr_triples/attr_triples_DBP_en' \
#    --KG2_rel_triple_path ${data_folder}'processed_data/rel_triples/rel_triples_DBP_de_V2' \
#    --KG2_attr_triple_path ${data_folder}'processed_data/attr_triples/attr_triples_DBP_de' \
#    --ent_link_path ${data_folder}'processed_data/ent_links/ent_links_DBP_en_DBP_de' \
#    --ent_link_num 15000 \
#    --init_speed 0.25 \
#    --pre_delete 0 >> ${data_folder}sampled_data/log/${target_dataset}_${cur_time}.log
